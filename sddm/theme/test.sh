...
if [ ! -d "${THEMES_DIR}/kuvk" ]; then
    ...
    echo -e "Run ${cyan}'./install.sh'${reset} or copy the contents of the theme to ${cyan}'${THEMES_DIR}/kuvk/'${reset} and set the current theme to ${cyan}'kuvk'${reset} in ${cyan}'/etc/sddm.conf'${reset}:\n"
